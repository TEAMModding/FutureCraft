...
//import net.minecraft.inventory.SlotFurnace;// Error, now there are SlotFurnaceFuel and SlotFurnaceOutput.
...
public class ContainerAlloyFurnace extends Container
{
    ...
    public ContainerAlloyFurnace(InventoryPlayer p_i1812_1_, TileEntityAlloyFurnace p_i1812_2_)
    {
...
//        this.addSlotToContainer(new SlotFurnace(p_i1812_1_.player, p_i1812_2_, 2, 116, 35)); // Error, now there are SlotFurnaceFuel and SlotFurnaceOutput.
        int i;
